...
Итак, подпрограммы позволяют повторно использовать код, параметризировать его и в случае чего его можно изменить в угоду новых потребностей, а не бегать по всему проекту и бороться с дубликатами.
